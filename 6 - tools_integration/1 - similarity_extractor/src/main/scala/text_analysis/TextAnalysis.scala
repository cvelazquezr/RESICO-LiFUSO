...
object TextAnalysis:
  ...
  /** Divides the tag sentences into a list of tags.
    *
    * @param tags
    *   The tag sentence to divide.
    * @return
    *   A list of tags composing the tag sentence.
    */
  ...
  /** Performs several operations on a text. Operations can be defined as
    * functions and are applied sequentially to the text.
    *
    * @param text
    *   The text to be processed by the operations.
    * @param operations
    *   The operations in form of functions to be applied to the text.
    * @return
    *   A transformed version of the text after the application of the
    *   operations.
    */
  def processText(
      text: List[String],
      operations: List[List[String] => List[String]]
  ): List[String] =
    var textTransformed: List[String] = text
    operations.foreach(operation =>
      textTransformed = operation(textTransformed)
    )
    textTransformed
  ...
  /** Extracts the non-code part from a code snippet.
    *
    * @param body
    *   The body of the code snippet from which the text needs to be extracted.
    * @return
    *   The elements on the code snippet with no code on them. Diverse elements
    *   can be returned instead of just one monolithic text.
    */
  def extractBodyNoCode(body: String): List[String] =
    ...
    for i <- 0 until nonCodeElements.size() do
  ...
  /** Divides a word by its camel case style.
    ...
    * @return
    *   A list from which its elements correspond to each case in the camel-case
    *   style.
    *
    * @example
    *   {{{
  ...
  /** Transforms the text by dividing camel case words. Extends the camel case
    * version for a single word:
    * @see
    *   splitCamelCaseWord
    *
    * @param text
    ...
    * @return
    *   A camel-case divided version of the text passed as arguments.
    */
  def splitCamelCaseText(text: List[String]): List[String] =
    text
      .map(word => splitCamelCaseWord(word).mkString(" "))
      .mkString(" ")
      .split(" ")
      .toList

  /** Cleanse the text by excluding non-desired symbols (e.g., punctuations,
    * parenthesis, etc.)
    *
    * @param text
    *   The text to be processed.
    * @return
    *   A cleaned version of the text passed as parameter.
    */
  ...
  /** Lowers the words passed as parameters.
    *
    * @param text
    *   The text to be lowered.
    * @return
    *   A lowered version of the text.
    */
  ...
  /** Filters out the words in the stop words list.
    ...
    *   The text to be processed.
    * @return
    *   A cleaned version of the text without the stop words defined in the
    *   list.
    */
  def stopWords(text: List[String]): List[String] =
    val sourceStopWords: Source =
      Source.fromFile("src/main/resources/stopwords.txt")
  ...
  /** Stems the words passed in the text as arguments.
    ...
    *   The text to be processed.
    * @return
    *   A stemmed version of the words in the text.
    */
  ...
  /** Extracts the lemmas of the words passed in the text as arguments.
    ...
    *   The text to be processed.
    * @param posTagger
    *   A configured POS model.
    * @param dictionaryLemmatizer
    *   A dictionary with the lemmatized words.
    * @return
    *   A lemmatized version of the words in the text.
    */
  def lemmatizing(
      text: List[String],
    ...
    val lemmatizedText: List[String] =
      dictionaryLemmatizer.lemmatize(text.toArray, tagsText).toList

    var fixedText: Array[String] = Array()

    for i <- lemmatizedText.indices do
      if lemmatizedText(i).equals("O") then fixedText :+= text(i)
      else fixedText :+= lemmatizedText(i)

    fixedText.toList

  /** Filters the words of the text which do not represent some valuable
    * information to consider. The procedure should exclude related to (this is
    * not an exhaustive list): library names, programming languages, IDEs,
    * framework names, operating systems, etc.
    *
    * @param text
    *   The text to be filtered.
    * @param artifactID
    *   The name of the artifactID of the library.
    * @return
    *   A filtered representation of the text.
    */
